# 🎓 英语对话练习助手 - 双Agent语音交互版

## 📋 项目简介

这是一个基于双Agent架构的英语对话练习应用，集成了腾讯云语音识别服务，让用户可以通过语音与AI助手进行自然的英语对话练习。

## 🌟 核心功能

### 🤖 双Agent对话系统
- **Agent1 - 英语对话助手**：与用户进行自然的英语对话交流
- **Agent2 - 表达改进助手**：改进用户的英语表达，提供更地道的表达方式
- **流式响应**：支持实时流式对话，体验更自然
- **多模型支持**：支持通义千问、DeepSeek等多种LLM

### 🎙️ 语音交互功能
- **实时语音识别**：基于腾讯云ASR，支持中文普通话识别
...
```javascript
// ASR引擎配置
engine_model_type: '16k_zh-PY'  // 16k中文普通话模型
...
# 测试语音服务
curl http://localhost:5000/api/speech/sts-credentials
```
...
- 📱 **移动端优化**：改进移动设备上的交互体验
- 🎯 **语音评测**：集成语音评测功能，提供发音指导
- 🤖 **智能推荐**：基于用户水平推荐合适的练习内容
